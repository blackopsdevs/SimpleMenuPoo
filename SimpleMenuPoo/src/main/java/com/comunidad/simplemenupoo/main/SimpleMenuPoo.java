 ...
 */
package com.comunidad.simplemenupoo.main;

import com.comunidad.simplemenupoo.main.poo.DatosService;
import com.comunidad.simplemenupoo.main.poo.DatosVo;
            ...
            try {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        datosService.addDatos(new DatosVo(id, nombre, apePaterno, apeMaterno, genero));
                    ...
                    case 2:
                        ...
                        listaDatos = datosService.listDatos();
